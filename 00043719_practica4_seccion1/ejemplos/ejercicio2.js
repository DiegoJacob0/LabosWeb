...
//contener letras, numeros, _ o $
var $jquery, _private;

//empezar por numeros o contener espacios
var 50cent = 1, esto no vale = 1;

//son case sensitive
var variable = 2, VARIABLE = 2;
//mayoritariamente se usa camelCase, pero tambien se usa snake_case
var camelCase = 2, snake_case = 2;
//se recomienda declarar una variable por linea
var camelCase = 2;
var snake_case = 3;
...
switch (numero) {
    case "5":
        alert("iNúmero correcto!");
        break;
    case "4":
    case "6":
        alert("iCasi aciertas!");
        break;
    default:
        alert("Frío, frío")
}
